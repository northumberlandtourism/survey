...
$databaselocation   =   'localhost:/tmp/mysql5.sock';   // Network location of your Database - for odbc_mssql or mssqlnative use the mssql servername, not localhost or IP
$databasename       =   'db488694437';  // The name of the database that we will create
$databaseuser       =   'dbo488694437';        // The name of a user with rights to create db (or if db already exists, then rights within that db)
$databasepass       =   'N0rthumberland2013';            // Password of db user
...
// Installation Setup
$defaultuser        =   'ian.perks';           // This is the username when LimeSurvey is installed and the administration user is created on installation
$defaultpass        =   'n0rthumberland';        // This is the password for the administration user when LimeSurvey is installed
